                  ...
                  <div className="container-fluid">
                    <div className="row">
                      ...
                      <div className="col-md-6 modalBody">
                        ...
                        <div>Champion Level: {this.props.champion.championLevel}</div>
                        <div>Champion Points: {helpers.format(this.props.champion.championPoints)}</div>
                        <div>Points Since Last Level: {helpers.format(this.props.champion.championPointsSinceLastLevel)}</div>
                        <div>Points Unitl Next Level: {helpers.format(this.props.champion.championPointsUntilNextLevel)}</div>
                        <div>Mastery Tokens: {this.props.champion.tokensEarned}</div>
                        <div>Chest Earned: {helpers.chest(this.props.champion.chestGranted)}</div>
                        <div>Last Time Played: {helpers.formatDate(this.props.champion.lastPlayTime)}</div>
                      </div>
                    </div>
                  </div>
                </div>
