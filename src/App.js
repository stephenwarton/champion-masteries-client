            ...
            <div>
              <h2>
                ...
                <img
                  ...
                  alt={this.state.user.icon}
                />
              </h2>
              <h4>
                Mastery Level: {helpers.format(this.state.user.masteryLevel)}
              </h4>
              <div className="row">
                <div className="col-md-4">
                  <h4>
                    Total Mastery Points:{' '}
                    {helpers.format(this.state.user.points)}
                  </h4>
                </div>
              ...
              <ChampionsContainer
                masteries={this.state.masteries}
                champName={this.state.champName}
                filterOption={this.state.option}
              />
            </div>
          ) : null}
          <div className="footer">
            <small>Made by Stephen W.</small>
          </div>
        </div>
      </div>
    );
